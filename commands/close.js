...
module.exports.run = async (bot, message, args) => {
  ...
  hastebin.createPaste(text, {
    ...
    .setDescription(`Closed By: ${message.author} (${message.author.id})\nTicket Number: \`${ticketcount}\`\nClose Reason: \`${reasonfetch}\`\nTranscript: [Here](${data})\nDeleting Channel in: 10 minutes`)
    // .setFooter(``)
    let logchannel = message.guild.channels.find(cl => cl.name === "ticket-logs")
